...
/**
 * The mod_sampleassessment sample grade updated event.
 *
...
/**
 * The mod_sampleassessment sample grade updated event class.
 *
 * @package    mod_sampleassessment
 * @since      Moodle 2.7
 * @copyright  2014 Andy Chan
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sample_grade_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the sample grade for student (".$this->other['samplename'].") in the sampleassessment activity
    ...
    public static function get_name() {
        return get_string('eventsamplegradeupdated', 'mod_sampleassessment');
    }
